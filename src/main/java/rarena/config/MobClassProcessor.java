...
import rarena.MobClassCollection;

public class MobClassProcessor extends BaseConfigurationProcessor<MobClassCollection>
{
	@Override
	public MobClassCollection readFromStream(InputStream inputStream) throws ConfigurationProcessingException
	{	
		/*try
		{
	...
	@Override
	public void writeToStream(OutputStream outputStream, MobClassCollection data) throws ConfigurationProcessingException
	{
